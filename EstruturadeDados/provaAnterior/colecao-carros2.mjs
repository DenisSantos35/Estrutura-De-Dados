/*
    1. O Professor Alexandre é colecionador de carros antigos.
    Segue a coleção de carros do professor Alexandre:

    FIAT 147, CHEVETTE STANDARD, KADETT GL, OPALA COMODORO, OMEGA DIAMOND, OPALA DIPLOMATA,
    KARMANN GHIA, FUSCA 1300, ALFA ROMEO.

    
    2. Iremos organizar a coleção de carros com nossa Estrutura de Dados de Lista Encadeada.
...
/*
    3. Faça com que a coleção de carros do Professor Alexandre fique nas suas respectivas garagens(numeradas):
...
lista.insert(1,'CHEVETTE STANDARD');
lista.insert(2,'KADETT GL');
lista.insert(3,'OPALA COMODORO');
lista.insert(4,'OMEGA DIAMOND');
lista.insert(5,'KARMANN GHIA');
lista.insert(6,'FUSCA 1300');
lista.insert(7,'OPALA COMODORO');
lista.insert(8,'ALFA ROMEO');

/*
    4. Imprima a coleção na ordem correta.
*/
console.log(lista.print());

/*
    5. O Professor Alexandre decidiu comprar mais 1 carro para sua coleção e colocá-lo na garegem
    de número (3). O carro que ele comprou foi o "TOYOTA BANDEIRANTE".
    Com isso, automaticamente os carros seguintes irão mudar para as suas garagens sucessoras.
*/
lista.insert(3, 'TOYOTA BANDEIRANTE');
console.log(lista.print());

/*
    6. O Professor Alexandre decidiu vender o carro "FIAT 147" de sua coleção:
    Remova esse carro, mostre no console esse carro removido e em seguida imprima
    a coleção na ordem correta.
*/
let itemAremover = lista.indexOf("Fiat 147")
let removido = lista.remove(itemAremover);
console.log(`Carro removido: ${removido}`);
console.log(lista.print());

/*
    7. O Professor Alexandre decidiu vender o carro "ALFA ROMEO" de sua coleção:
    Remova esse carro, mostre no console esse carro removido e em seguida imprima
    a coleção na ordem correta.
*/
itemAremover = lista.indexOf("ALFA ROMEO");
console.log(itemAremover);
removido = lista.remove(itemAremover);
console.log(`Carro removido: ${removido}`);
console.log(lista.print());